...
from src.utils.misc import (nested_tensor_from_tensor_list,
...
class DETR_Criterion(nn.Module):
    ...
    """
    def __init__(self, num_classes, matcher, weight_dict, eos_coef, losses, nf_penalty):
    ...
    def forward(self, outputs, targets):
        ...
        metric = {**loss_dict_reduced_scaled, **loss_dict_reduced_unscaled}
